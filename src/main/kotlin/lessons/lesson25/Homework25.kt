...
//Задание 2: Использование apply для инициализации объекта Employee
    ...
    val person = Person("Andrew", 25).apply {
        email = "Adnrew_help@bishkek.com"
    }

    val employee = Employee(person.name, person.age, "QA_engineer").apply {
        email = person.email
        department = "Web_development"
    }

    val person1 = Person("Jamal", 28)
        .also { it.email = "Jamal@test.com" }
        .also { logPerson(it) }

...
//Для рекурсивного перебора директорий и файлов применяется метод walk() который предоставляет последовательность sequence которую можно фильтровать и преобразовывать так, как это нужно.
